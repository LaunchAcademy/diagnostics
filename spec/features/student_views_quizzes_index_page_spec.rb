...
feature "Student Views Quizzes Index Page", %(
  ...
  Acceptance Criteria:
  * [x] Student views quizzes index page upon login
  ...
  * [x] Provides a notice about the number of unfinished quizzes
) do
  ...
  scenario "student views quizzes index page upon login" do
    sign_in(user)

    expect(page).to have_content "All Quizzes"
  end
